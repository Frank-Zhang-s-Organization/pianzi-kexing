...
- [x] 将项目从 `Project-files` 中拆出，初始化独立 Git 仓库
- [x] 在 GitHub Organization 下创建远端仓库并推送
- [x] 将仓库切换为公开状态
- [x] 重写 README，提高对开发者和硬件厂商的呼吁能力
- [x] 补齐 `SECURITY.md`、`CODE_OF_CONDUCT.md`、`SUPPORT.md`、`CONTRIBUTING.md`
- [x] 补齐 `LICENSE` 与 `LICENSE.zh-CN.md`
- [x] 补齐 GitHub issue / PR 模板与基础治理标签
...
- “骗子克星”已在 GitHub Organization 下公开发布
